...
import controller.grey.GreenScale;
import model.IImage;
...
/**
 * Tests our green scale command.
 */
public class GreenScaleTest {
  @Test
  public void testGreen() {
    ...
    ImageCommand green = new GreenScale();
    IImage newMod = green.process(mod, "rainbow");
